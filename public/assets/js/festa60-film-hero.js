(function () {
  ...
  const eraStories = {
    ...
    "1993-96": {
      label: "21〜30年｜平成5〜8年",
      range: "1993–96",
      club: "学園祭や競技会を重ね、1996年に田中・木戸組が冬全サンバ優勝。創部30年目、理科大初の全日本制覇を成し遂げる。",
    ...
    "1997-99": {
      ...
      range: "1997–99",
      club: "1999年、伊從・大崎組が夏全ラテン総合優勝。1996年の初制覇から3年、引退試合で再び全国の頂点に立つ。",
    ...
    "2000-02": {
      ...
      range: "2000–02",
      club: "2001年、東部Ⅱ部戦団体優勝。夏全モダン2位、冬全クイック2位に加え、ワルツ6位・チャチャ7位。複数種目で全国決勝へ進む。",
    ...
    "2003-06": {
      ...
      range: "2003–06",
      club: "2004年Ⅰ部校昇格。2005年は夏全団体5位・冬全団体3位、2006年は夏全ラテン総合と冬全チャチャチャを制し、黄金期を刻む。",
    ...
    "2007-09": {
      ...
      range: "2007–09",
      club: "2008年FANTASISTA発足。同年に冬全モダン種目を初制覇し、2009年は別の組がクイック優勝。二世代で連覇をつなぐ。",
    ...
    "2010-12": {
      ...
      range: "2010–12",
      club: "2010年冬全ワルツ2位。若代・伊藤組は理科大で唯一の冬全3年連続決勝進出。2012年には六大学戦と全国の舞台で次世代が躍進する。",
    ...
    "2013-16": {
      ...
      range: "2013–16",
      club: "2014年の活動休止と体制見直しを、現役とOBOGの支援で乗り越える。2016年は創部50周年、初の冬全ルンバ優勝、Ⅰ部校再昇格。",
    ...
    "2017-19": {
      ...
      range: "2017–19",
      club: "2017年、FANTASISTAと現役が力を合わせFMドレスを調達。翌2018年に冬全FM初出場。2016〜19年は冬全4年連続優勝をつなぐ。",
    ...
    "2020-22": {
      label: "51〜60年｜令和2〜4年",
      range: "2020–22",
      club: "2020年、活動制約の中でも冬全ワルツ2位。2021年夏全ラテン5位・冬全チャチャ3位、2022年冬全チャチャ2位へつなぐ。",
  ...
  const competitionStories = {
    ...
    "2013-16": "再起と躍進｜Ⅰ部校再昇格・2016 冬全ルンバ優勝",
    "2017-19": "4年連続冬全優勝｜2017 Q・2018 R・2019 Tへ継承",
